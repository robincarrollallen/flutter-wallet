...
void main() {
  ...
  const suiBech =
      'suiprivkey1qq3zyg3zyg3zyg3zyg3zyg3zyg3zyg3zyg3zyg3zyg3zyg3zyg3zyqz52s0';
  const suiAddr =
      '0x48936240c871663e6ba416724158736101ccab29436f72ae3ae4c8fa1ce7e45f';
  ...
  test('derive(unknown) 抛错', () {
    expect(
      () => PrivateKeyService.derive(PrivateKeyKind.unknown, 'x'),
      throwsArgumentError,
    );
  });
}
