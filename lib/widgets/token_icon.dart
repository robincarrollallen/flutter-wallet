...
class TokenIcon extends StatelessWidget {
  const TokenIcon({super.key, required this.symbol, this.logoUrl, this.size = 28, this.background});
  ...
  Widget _fallback(BuildContext context) {
    ...
    return Container(
      ...
      child: Text(
        label,
        style: TextStyle(color: theme.colorScheme.onPrimary, fontSize: size * 0.5, fontWeight: FontWeight.bold),
      ),
    );
  }
}
