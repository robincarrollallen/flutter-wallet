...
class ImportWalletLogic {
  ...
  static const softwareWallets = <WalletBrand>[
    WalletBrand(
      ...
      fallbackLabel: 'M',
      fallbackColor: Color(0xFFF6851B),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/trust.webp',
      fallbackLabel: 'T',
      fallbackColor: Color(0xFF3375BB),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/coinbase.webp',
      fallbackLabel: 'C',
      fallbackColor: Color(0xFF0052FF),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/bitget.webp',
      fallbackLabel: 'B',
      fallbackColor: Color(0xFF00F0FF),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/okx.webp',
      fallbackLabel: 'O',
  ...
  static const hardwareWallets = <WalletBrand>[
    WalletBrand(
      asset: 'assets/icons/wallets/ledger.webp',
      fallbackLabel: 'L',
      fallbackColor: Color(0xFF000000),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/trezor.webp',
      fallbackLabel: 'T',
      fallbackColor: Color(0xFF00C389),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/keystone.webp',
      fallbackLabel: 'K',
      fallbackColor: Color(0xFFFF5C00),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/safepal.webp',
      fallbackLabel: 'S',
      fallbackColor: Color(0xFF4A6CF7),
    ),
    WalletBrand(
      asset: 'assets/icons/wallets/onekey.webp',
      fallbackLabel: 'O',
      fallbackColor: Color(0xFF00B812),
    ),
  ];
