...
import '../../services/security_password_storage.dart';
...
class SetSecurityPasswordPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<SetSecurityPasswordPage> createState() =>
      _SetSecurityPasswordPageState();
}

class _SetSecurityPasswordPageState
    extends ConsumerState<SetSecurityPasswordPage> {
  ...
  Future<void> _submit() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('安全码设置成功')),
    );
