...
class VerifySecurityPasswordPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<VerifySecurityPasswordPage> createState() =>
      _VerifySecurityPasswordPageState();
}

class _VerifySecurityPasswordPageState
    extends ConsumerState<VerifySecurityPasswordPage> {
