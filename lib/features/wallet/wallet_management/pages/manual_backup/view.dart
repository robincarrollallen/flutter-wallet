...
class _ManualBackupPageState extends ConsumerState<ManualBackupPage> {
  ...
  void _onNext() {
    ...
    Navigator.of(context).push(panelSlideRoute(VerifyMnemonicPage(wallet: widget.wallet, mnemonic: mnemonic)));
  }
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(Icons.warning_amber_rounded, size: 20.s, color: theme.colorScheme.onErrorContainer),
                      Expanded(
                        child: Text(
          ...
          child: loading
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Text('点击展示助记词', style: theme.textTheme.bodyMedium?.copyWith(color: theme.colorScheme.primary)),
                  ],
                ),
        ),
      ),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text('${i + 1}', style: theme.textTheme.bodySmall?.copyWith()),
                  ),
                  Expanded(child: Text(words[i], style: theme.textTheme.labelLarge?.copyWith())),
                ],
              ),
            ),
        ],
