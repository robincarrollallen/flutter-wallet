...
class PrivateKeyViewPage extends ConsumerStatefulWidget {
  const PrivateKeyViewPage({super.key, required this.wallet, required this.chain});
      ...
      children: [
        ...
        Container(
          ...
          child: Text(
            ...
            style: theme.textTheme.bodyMedium?.copyWith(letterSpacing: 2, color: theme.colorScheme.onSurfaceVariant),
          ),
        ),
      ],
    );
