...
class WalletManagementLogic {
  ...
  static double panelProgress({required double routeValue, required double dragOffset, required double panelHeight}) {
  ...
  static bool shouldClose({required double dragOffset, required double panelHeight, required double velocity}) {
