...
@immutable
class TabItem {
  const TabItem({required this.label, required this.icon, required this.activeIcon});
...
const List<TabItem> kTabs = [
  TabItem(label: _homeLabel, icon: Icons.home_outlined, activeIcon: Icons.home),
  TabItem(label: _marketLabel, icon: Icons.show_chart_outlined, activeIcon: Icons.show_chart),
  TabItem(label: _exchangeLabel, icon: Icons.swap_horiz_outlined, activeIcon: Icons.swap_horiz),
  TabItem(label: _contractLabel, icon: Icons.description_outlined, activeIcon: Icons.description),
  TabItem(label: _discoverLabel, icon: Icons.explore_outlined, activeIcon: Icons.explore),
];
