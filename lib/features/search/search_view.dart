            ...
            child: Material(
              ...
              child: InkWell(
                ...
                child: Padding(
                  ...
                  child: Icon(Icons.close, size: 20.s, color: theme.colorScheme.onSurface),
                ),
              ),
            ),
          ),
              ...
              headerSliverBuilder: (context, _) => [
                ...
                SliverToBoxAdapter(
                  child: Padding(
                    ...
                    child: Text(t.search.hot, style: theme.textTheme.titleSmall?.copyWith(fontWeight: FontWeight.bold)),
                  ),
                ),
                SliverPersistentHeader(
                  ...
                  delegate: _PinnedTabBarDelegate(
                    ...
                    child: Align(alignment: Alignment.centerLeft, child: _buildTabBar(theme)),
                  ),
                ),
              ],
              body: _tabViews(),
...
class _PinnedTabBarDelegate extends SliverPersistentHeaderDelegate {
  _PinnedTabBarDelegate({required this.child, required this.height, required this.background});
