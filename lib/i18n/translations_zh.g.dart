...
class _Translations$transactionHistory$zh extends Translations$transactionHistory$en {
	...
	@override String get fieldToken => '币种';
	@override String get fieldFee => '手续费';
	@override String get fieldBlock => '区块高度';
	@override String get fieldConfirmedAt => '上链时间';
	@override String get nativeCoin => '原生币';
	@override String get viewOnExplorer => '在区块浏览器查看';
	@override String get openExplorerFailed => '打不开区块浏览器';
...
extension on TranslationsZh {
	dynamic _flatMapFunction(String path) {
		return switch (path) {
			...
			'transactionHistory.fieldToken' => '币种',
			'transactionHistory.fieldFee' => '手续费',
			'transactionHistory.fieldBlock' => '区块高度',
			'transactionHistory.fieldConfirmedAt' => '上链时间',
			'transactionHistory.nativeCoin' => '原生币',
			'transactionHistory.viewOnExplorer' => '在区块浏览器查看',
			'transactionHistory.openExplorerFailed' => '打不开区块浏览器',
