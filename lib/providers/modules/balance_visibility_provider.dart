...
class BalanceHiddenNotifier extends Notifier<bool> with PersistentNotifier<bool> {
  ...
  @override
  bool fromJson(Map<String, dynamic> json, bool fallback) => json['hidden'] as bool? ?? fallback;
...
final balanceHiddenProvider = NotifierProvider<BalanceHiddenNotifier, bool>(BalanceHiddenNotifier.new);
